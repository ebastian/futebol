...
var TeamsComponent = (function (_super) {
    __extends(TeamsComponent, _super);
    function TeamsComponent(router, teamService) {
        _super.call(this, router, teamService);
        this.title = "Times";
        this.formpath = "team";
        this.columns = [
            {
    ...
    TeamsComponent = __decorate([
        ...
        __param(1, core_1.Inject(team_service_1.TeamService)), 
